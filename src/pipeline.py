...
def run_pipeline(image_path: str, image_url: str = None):
    print(f"\n[1/3] Detecting & encoding face in {image_path} ...")
    face_result = encode_face(image_path)
    print(f"  -> Face found. Image SHA-256: {face_result['image_sha256']}")

    print("\n[2/3] Searching the web for a matching social media post ...")
    ...
    print("\n[3/3] Uploading tamper-evident proof to blockchain (Sepolia testnet) ...")
